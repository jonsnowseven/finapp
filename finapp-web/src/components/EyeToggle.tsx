...
export default function EyeToggle({ className = '' }: { className?: string }) {
  ...
  return (
    <button onClick={toggle} title={hidden ? 'Show balances' : 'Hide balances'}
      ...
      className={`p-2 rounded-lg text-gray-500 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gold-300 hover:bg-gray-100 dark:hover:bg-surface-3 ${className}`}>
